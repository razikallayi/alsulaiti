...
e-mail: info@mcl-kw.com
    ...
    <div id="primoPiano-view">
        <div id="doha-qatar" class="news-list">
            <div class="gmap">
            	<div class="gmap-head">Corniche, Doha, Qatar</div>
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115438.1636620772!2d51.4594189295972!3d25.289329129232602!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e45c534ffdce87f%3A0x44d9319f78cfd4b1!2sDoha!5e0!3m2!1sen!2sqa!4v1473072677311" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
...
<div class="getint" id="contact">
  ...
  <div class="container">
     <div class="col-md-12 no-padding">
         <div class="row">
           	<div class="col-md-6">
               	<h2> <img src="images/icons/git.png">  Get in Touch <br> <span>With Us</span></h2>
                <h4>Fill Out Our Contact form and one of our Team Member will be in touch with you.</h4>
                
            </div>
            
            <div class="col-md-6">
              <form id="contact_form" action="contact_mail.php" method="post">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="icon-addon addon-lg">
                      <textarea name="message" class="form-control" id="textarea" placeholder="Message" required></textarea>
...
<script>
  $('#contact_form').submit(function(e) {
    ...
    $.ajax({
      ...
      data: {
        'key': '91fa69ab5b2843a9d36050bf8c33d4e5-us13',
        'message': {
          'from_email': 'mail@whytecompany.com',
          'to': [
          {
