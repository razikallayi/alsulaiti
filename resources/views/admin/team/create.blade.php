				...
				<div class="row clearfix">
					...
					<label>Name</label>
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$team->name or old('name')}}" name="name" maxlength="191" " class="form-control" required="">
							</div>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="col-sm-12">
					...
					<div id="result" class="connectedSortable">
						...
						<div id="image-preview-{{substr($team->image,0,-4)}}" class="col-lg-3 col-md-4 col-sm-6 m-t-30 sort_handle" style="min-height:100px">
							<span>
								<button type="button" style="float:right;" onclick="deleteImage('{{$team->image}}')" class="btn btn-xs  waves-effect btn-danger pull-right"><i class="material-icons">close</i></button>
