...
<div class="row">
	...
	<div class="card">
		<div class="header bg-project">
			<h2 class="">Manage Client<a href="{{url('admin/client')}}"><i class="material-icons pull-right">view_list</i></a></h2>
		</div>
	</div>
			...
			<div class="card">
				<div class="header" >
					<h2 style="white-space: nowrap;overflow:hidden">
						<span>{{str_limit($client->title,40)}}</span>
						<small>{{str_limit(strip_tags($client->content),70)}}</small>
					</h2>
