   ...
   <div class="container">
      <div class="col-md-12">
         <div class="col-md-3 no-padding">
            <div class="flw">
               <h3>Follow Us</h3>
               <img src="images/ftr-logo.png" class="img-responsive" alt="Law Firms Qatar">
               <ul>
         ...
         <div class="col-md-5 no-padding">
           <div class="brouchure-sec clearfix">
              <div class="col-md-12 no-padding clearfix"><div class="tp"><a href="#top"><img src="images/top.png" alt="Legal Consultancy Qatar"></a></div></div>
              <div class="col-md-12 no-padding clearfix">
                 ...
                 <div class="col-md-5 no-padding">
                  <div class="blt">
                        <a href="profile.php" target="_blank"><img src="images/download.png" alt="Qatar Law Firms"><h5>Click to download<br> <span>Brochure</span></h5></a>
                     </div>
                 </div>
              </div>
           </div>
           ...
           <div class="latest-events">
              <!--<div id="owl-demo1" class="owl-carousel clearfix">
                <div class="item">
                <div class="le-img"><img src="images/le1.jpg" class="img-responsive"><div class="le-imtxt">Latest <span>Events</span></div></div>
                <div class="le-txt">
...
<div class="footer-btm">
  <div class="container">
  		<div class="col-md-12">
           ...
           <div class="pwb">Powered by  <a href="http://www.whytecreations.com/" target="_blank" rel="dofollow"> <img src="images/whyte.jpg" alt="Web Design Companies Qatar">         Whyte Company </a></div>
        </div>
  </div>
</div> 
