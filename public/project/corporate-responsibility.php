...
<div class="res-top">
	<div class="container">
       <div class="col-md-12 no-padding">
          ...
          <div class="col-md-6">
             <h4>Our Responsibilities <img src="images/icons/res-tp.png"> </h4>
...
<dl class="responsive-tabs">
  <dt>Pro bono and the community</dt>
  <dd >
  <div class="container">
    ...
    <div class="col-md-9 animated fadeInDown">
      ...
      <p>As lawyers we care passionately about improving our society and always giving back to our community for the public good. We represent several clients pro bono. At Al Sulaiti Law firm No distinction is made between Pro bono clients and other clients in working hours; we respect and treat all our clients fairly whilst ensuring that they are provided with the best legal services.</p>
      <a href="pdf/human-rights-policy.pdf" target="_blank" class="dcrp pub" >The Human Rights Policy</a>
    </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="col-md-9 animated fadeInDown">
      ...
      <p>
Caring about the environment surrounding us is vital that is why we chose to recycle used and waste papers.</p>
<p>
But it isn’t limited to just recycling, monitoring our electricity and energy and turning off power sources that are not in use. All of our office computers are switched off at the end of the day and the power sources too.</p>
<p>
We only use mugs in our offices to avoid using and wasting plastic/paper cups.</p>
<a href="pdf/enviromental-policy.pdf" target="_blank" class="dcrp pub" >The Environmental Policy</a>
    </div>
    </div>
  </div>
