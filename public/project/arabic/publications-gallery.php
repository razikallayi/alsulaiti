...
<div class="publication-in">
  <div class="container">
     <div class="col-md-12 no-padding">
        <div class="row">
           <div class="col-md-12">
           		<h4 style="text-align:center; font-size:40px" dir="rtl">قريبا</h4>
           </div>
     ...
     <div class="col-md-12 no-padding">
       <a href="../pdf/corporate-responsibility.pdf" download="corporate Responsibility" class="dcrp pub" dir="rtl">اضغطهنا</a>
     </div>
  </div>
